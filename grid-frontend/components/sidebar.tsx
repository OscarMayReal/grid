...
export const AdminSidebar = ({ ignoreSize }: { ignoreSize?: boolean }) => {
    ...
    return (
        <div className="sidebar">
            ...
            <SidebarItem title="Devices" onClick={() => { router.push("/admin/devices") }} Icon={LaptopMinimalIcon} active={path === "/admin/devices"} index={1} />
            ...
            <SidebarItem title="Settings" onClick={() => { router.push("/admin/settings") }} Icon={SettingsIcon} active={path.startsWith("/admin/settings")} index={5} />
            ...
            <SidebarItem title="Portal" onClick={() => { router.push("/portal") }} Icon={LayoutDashboardIcon} active={false} index={7} />
        </div>
    );
};
